...
//         <div clasName='flex justify-between items-center text-base gap-8'>
//           {/* logo */}
//           <Link to="/" className='text-2*1 font-bold text-blue-700 flex items-center gap-2'>
...
//         <div clasName={`space-y-4 px-4 mt-16 py-7 bg-blue-700 ${isMenuOpen ? "block fixed top-0 right-0 left-0" : "hidden"}`}>
//         {
//           navItems.map(({ link, path }) => (
